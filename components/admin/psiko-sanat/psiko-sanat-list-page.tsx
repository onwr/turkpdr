...
export function PsikoSanatListPage({ userRole }: PsikoSanatListPageProps) {
  ...
  const fetchItems = useCallback(async () => {
    ...
    const params = new URLSearchParams({ type: "PSIKO_SANAT" });
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="flex items-center gap-2 text-xl font-semibold text-brand-navy sm:text-2xl">
            <Palette className="size-6 text-brand-blue" />
            Psiko Sanat Yönetimi
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Kitap, film, sanat ve psikoloji içeriklerini yönetin.
          </p>
        </div>
        <Button
          ...
          asChild
        >
          <Link href="/admin/psiko-sanat/new">
          ...
          <table className="w-full min-w-[900px] text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {loading && items.length === 0 ? (
                ...
                <AdminTableEmptyRow colSpan={7} label="İçerik bulunamadı." />
              ) : (
                items.map((item) => {
                      ...
                      <td className="px-5 py-3.5 sm:px-6">
                        <div className="flex flex-wrap items-center gap-1">
                          ...
                          <Button
                            ...
                            asChild
                          >
                            <Link href={`/admin/psiko-sanat/${item.id}/edit`}>
                          ...
                          <Button
                            ...
                            disabled={isBusy}
                            onClick={() =>
                              void toggleFeatured(item.id, !item.featured)
                            }
                            title={
